  ...
  return (
    <div className="w-full min-h-full bg-white">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Craft a professional resume in minutes with our resume builder.
              Choose from stunning templates, customize your content, and
              download your resume hassle-free.
            </p>
            <button
        ...
        <section className="mt-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              <h3 className="text-lg font-semibold mb-3">One-Click Download</h3>
              <p className="text-gray-600">
      ...
      <div className="text-sm bg-gray-50 text-secondary text-center p-5 mt-5">
        Made by Harshit Singhal in 2026
      </div>
